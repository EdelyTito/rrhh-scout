      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        ...
        <form @submit.prevent="enviarFormulario" class="p-6 space-y-8">
          ...
          <div class="border-b border-gray-200 pb-8">
            ...
            <div
              v-if="formulario.formularioASB === 'NO'"
              class="mt-4 bg-red-50 border border-red-200 text-red-700 p-4 rounded-lg"
            >
              <p class="font-semibold">
                ⚠️ No puede continuar con el formulario
              </p>
              <p class="text-sm mt-1">
                Para solicitar la habilitación como dirigente, es obligatorio haber
                completado previamente el formulario de la ASB.
              </p>
            </div>

          </div>

          <div v-if="!asbNoCompletado">
            <!-- DATOS PERSONALES -->
            <div class="border-b border-gray-200 pb-8">
            ...
            <div>
              ...
              <div class="flex justify-between pt-6">
                ...
                <button 
                  type="submit"
                  :disabled="enviando || asbNoCompletado"
...
const asbNoCompletado = computed(() => formulario.value.formularioASB === 'NO')
...
const validarFormulario = () => {
  ...
  if (formulario.value.formularioASB === 'NO') {
    alert('No puede enviar el formulario sin haber completado el formulario de la ASB')
    return false
  }
